                ...
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <?php if(isset($_SESSION['auth'])) : ?>
                            <a class="nav-link my-2 my-sm-0 mr-2" href="pages/deconnexion.php" >Se déconnecter</a></li>
                            <a class="nav-link my-2 my-sm-0 mr-2" href="pages/compte.php">Mon compte</a></li>
                        <?php else: ?>
                            <a class="nav-link my-2 my-sm-0 mr-2" href="pages/connexion.php">
                    ...
                    <li class="nav-item">
                        <?php endif; ?>
                        <a class=" nav-link my-2 my-sm-0 mr-2" href = "pages/panier.php"> 
